def generate (names, goals, goals_avoided, assists):
    ...
    goals= Corresponde a una lista con la cantidad de goles realziados por los jugadores.
    goals_avoided= Corresponde a una lista con la cantidad de goles evitados por los jugadores.
    assists= Corresponde a una lista con la cantidad de asistencias realziada por los jugadores. 
...
def most_influent(statistics):
    ...
    statistics= Corresponde a la lista de tuplas con las estadísticas de los jugadores realziada previamente. 
